...
# B = AminoAcid("Asparagine or aspartic acid", 'B', "Asx", "", 114.53495, 114.5962, 9.2)
...
# O = AminoAcid("Pyrrolysine", 'O', "Pyl", "C12H21N3O3", 109.0528, 109.13, 0.0)
...
# Z = AminoAcid("Glutamine or glutamic acid", 'Z', "Glx", "", 128.55059, 128.6231, 9.8)
